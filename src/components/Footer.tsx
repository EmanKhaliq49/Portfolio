...
export default function Footer() {
  return (
    <footer className="bg-carbon/80 backdrop-blur-md text-f1Red pt-32 pb-16 px-8 md:px-24 border-t border-f1Red/20 relative z-20" id="contact">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-12 md:gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <a href="https://linkedin.com/in/eman-khaliq/" target="_blank" rel="noreferrer" className="text-xl md:text-2xl flex items-center justify-between border-b border-f1Red/30 pb-2 hover:text-white hover:border-white transition-all group">
              LinkedIn <ArrowUpRight size={24} className="group-hover:-translate-y-1 group-hover:translate-x-1 transition-transform" />
            </a>
            <a href="https://github.com/emankhaliq" target="_blank" rel="noreferrer" className="text-xl md:text-2xl flex items-center justify-between border-b border-f1Red/30 pb-2 hover:text-white hover:border-white transition-all group">
          ...
          <div className="flex flex-col justify-end text-right md:text-left mt-12 md:mt-0">
            <h2 className="text-xl md:text-2xl font-light mb-4">
              Designed and Developed <br /> by <span className="text-silverArrow font-bold">Eman Khaliq</span>
            </h2>
